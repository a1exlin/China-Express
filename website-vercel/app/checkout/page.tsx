...
export default function CheckoutPage() {
  ...
  const [orderDataForStripe, setOrderDataForStripe] = useState(null)
  ...
  const handlePlaceOrder = async (e) => {
    ...
    try {
      ...
      if (paymentMethod === "cash") {
        ...
        setOrderDataForStripe(orderData)
        ...
        <div className="md:col-span-2">
          ...
          <Card className="mt-8">
            ...
            <CardContent>
              ...
              {/* Stripe Payment Element - Only show after form submission */}
              {paymentMethod === "credit-card" && showStripePayment && clientSecret && (
                <div className="mt-6">
          ...
          {/* Place Order Button - Only show if not in Stripe payment mode */}
          {!(paymentMethod === "credit-card" && showStripePayment) && (
