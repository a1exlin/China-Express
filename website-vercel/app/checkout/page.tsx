...
export function ShoppingCart({ size = 24, ...props }: IconProps) {
  return (
    ...
    >
      ...
      <path d="M2.05 2.05h2l2.66 12.42a2 2 0 0 0 2 1.58h9.78a2 2 0 0 0 1.95-1.245L20.29 8H5.59" />
    </svg>
  )
}
...
export function Loader2({ size = 24, ...props }: IconProps) {
  return (
    ...
    >
      <path d="M12 2v4" />
      <path d="M4.93 4.93 2.82 2.82" />
      <path d="M2 12h4" />
      <path d="M4.93 19.07 2.82 21.18" />
      <path d="M12 22v-4" />
      <path d="M19.07 19.07 21.18 21.18" />
      <path d="M22 12h-4" />
      <path d="M19.07 4.93 21.18 2.82" />
...
export function Wallet({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M21 12V6H3l2-3h14a2 2 0 0 1 2 2v1" />
      <path d="M22 18a2 2 0 0 1-2 2H5l-2 3v-3" />
      <path d="M6 6 6 18" />
    </svg>
  )
}
...
export function PanelLeft({ size = 24, ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <rect width="7" height="12" x="3" y="6" rx="1" ry="1" />
      <rect width="7" height="12" x="14" y="6" rx="1" ry="1" />
    </svg>
  )
}
