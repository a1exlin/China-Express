...
import { Home, Menu, Phone, ShoppingCart, User, MapPin } from "lucide-react"
                ...
                <header className="sticky top-0 z-50 border-b bg-white">
                  <div className="container mx-auto flex h-16 items-center justify-between px-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Link href="/checkout">
                        <Button className="hidden bg-secondary hover:bg-secondary/90 md:inline-flex">Order Now</Button>
                      </Link>
                    </div>
                  </div>
                </header>
                    ...
                    <div className="grid gap-8 md:grid-cols-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          <span className="font-medium">Hours:</span> Mon-Sun: 11:00 AM - 10:00 PM
                        </p>
                      </div>
                      <div>
