...
type ConfirmationNavProp = NativeStackNavigationProp<RootStackParamList, "OrderConfirmation">
...
export default function OrderConfirmationScreen() {
  ...
  const { orderNumber, total, orderType } = route.params

  const estimatedTime = orderType === "delivery" ? "30-45 minutes" : "15-20 minutes"

  const handleTrackPress = () => {
    navigation.navigate("Track", { orderId: orderNumber })
  }
...
const styles = StyleSheet.create({
  ...
  estimatedTime: { fontSize: 14, color: "#666", marginBottom: 12 },
  ...
  homeButtonText: { color: "#c34428", fontWeight: "bold", fontSize: 16 },
})
