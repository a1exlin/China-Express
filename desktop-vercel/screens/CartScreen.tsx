  ...
  const handleCheckout = () => {
    if (subtotal < settings.minimumOrderAmount && orderType === "delivery") {
      Alert.alert(
        ...
        `The minimum order amount for delivery is $${settings.minimumOrderAmount.toFixed(2)}. Your current subtotal is $${subtotal.toFixed(2)}.`,
        [{ text: "OK" }],
      )
      return
    }
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.orderTypeContainer}>
        ...
        >
          ...
          <Text style={[styles.orderTypeText, orderType === "delivery" && styles.activeOrderTypeText]}>Delivery</Text>
        </TouchableOpacity>
        <TouchableOpacity
